...
export interface ParticleConfig {
	...
	readonly spinSpeed: readonly [
		number,
		number
	];
	/** Tilt range in degrees [min, max]. Default: [-30, 30] */
	readonly tilt: readonly [
		number,
		number
	];
...
export interface ConfettiBurstProps {
	...
	readonly triggerRef?: React$1.RefObject<HTMLElement>;
 ...
 */
export interface ConfettiButtonProps extends React$1.ButtonHTMLAttributes<HTMLButtonElement> {
	/** Configuration options */
 ...
 */
export declare const DIRECTION_ANGLES: Record<Exclude<BurstDirection, "custom" | "radial">, number>;
/**
